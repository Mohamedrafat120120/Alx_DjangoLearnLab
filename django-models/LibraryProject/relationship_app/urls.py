...
urlpatterns = [
    ...
    path('login/',LoginView.as_view(template_name='Alx_DjangoLearnLab/django-models/LibraryProject/relationship_app/User_Authentication/login.html'),name='logout'),
    path('logout/',LogoutView.as_view(template_name='Alx_DjangoLearnLab/django-models/LibraryProject/relationship_app/User_Authentication/login.html'),name='logout'),
